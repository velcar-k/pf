...
VERSION='20180302009' # Welcome to Brasil
...
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/velcar-k/pf/master/samba.inc
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/velcar-k/pf/master/samba.xml
...
cd /usr/local/pkg
fetch -o - -q https://raw.githubusercontent.com/velcar-k/pf/master/squid_winbind_auth.patch | patch -b -p0 -f
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/velcar-k/pf/master/squid.inc
